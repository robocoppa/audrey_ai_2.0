...
Run this from the checkout against the standalone UI proxy with an ordinary-user
credential and a different admin credential. It restores the user's exact
