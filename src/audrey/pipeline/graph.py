...
def build_graph(
    ...
    deep_react_max_web_searches = int(deep_react_cfg.get("max_web_searches", react_max_web_searches))
    ...
    async def node_research(state: PipelineState) -> dict[str, Any]:
        ...
        return {
            ...
            "research_ledger": result.get("research_ledger"),
            "research_factcheck_ledger": result.get("research_factcheck_ledger"),
            "research_dispositions": result.get("research_dispositions", ""),
