...
VERIFIER_SYSTEM = (
    ...
    "rankings. Core test: flag any wording that is STRONGER or MORE SPECIFIC "
    "than the findings support, and give the supported form. This covers "
    "sweeping quantifiers (\"virtually all\", \"every\", \"universally\"), "
    "origination claims (\"introduced\", \"invented\", \"the first to\", "
    "\"authored\" vs \"is attributed to\"), stated purposes (\"written for "
    "navigation\" when the source doesn't give a purpose), exact counts and "
    "superlatives, and finality words (\"proved\", \"complete\", "
    "\"definitive\") — but it is the principle, not the list, that governs: "
    "if a phrase claims more than the evidence shows, demote it. "
