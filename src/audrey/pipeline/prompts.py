...
WRITER_SYSTEM = (
    ...
    "omission.\n"
    "If a CLAIM DISPOSITIONS block is present, follow it per claim: STATE "
    "PLAINLY means assert it directly with NO hedging words (the grounding is "
    "solid — don't add caution it doesn't need); ATTRIBUTE TO SOURCE means "
    "name who claims it rather than stating it as fact ('Meta reports', 'the "
    "vendor claims'); HEDGE means soften as above. A disposition governs only "
    "that claim — it does not license hedging the rest of the answer.\n"
