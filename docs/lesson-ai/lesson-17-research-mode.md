...
[`run_research_pipeline_streaming`](../../src/audrey/pipeline/deep_panel.py#L1510);
...
> [never raises](../../src/audrey/pipeline/deep_panel.py#L1553) — each stage
...
([`deep_panel.py:1562`](../../src/audrey/pipeline/deep_panel.py#L1562)). Every
...
([`deep_panel.py:1674`](../../src/audrey/pipeline/deep_panel.py#L1674)) audits
...
([`deep_panel.py:1716`](../../src/audrey/pipeline/deep_panel.py#L1716)) is itself
...
[logs *which* precondition failed](../../src/audrey/pipeline/deep_panel.py#L1698)
...
([`deep_panel.py:1741`](../../src/audrey/pipeline/deep_panel.py#L1741)) into a
...
The writer ([`deep_panel.py:1789`](../../src/audrey/pipeline/deep_panel.py#L1789))
...
[`_render_sources_block`](../../src/audrey/pipeline/deep_panel.py#L1294). It takes
the sources backing claims the fact-checker did *not* drop, ranks them by
authority ([`_source_rank`](../../src/audrey/pipeline/deep_panel.py#L1252) — an
...
[`_render_dispositions_block`](../../src/audrey/pipeline/deep_panel.py#L1369).
...
([`_usable_url`](../../src/audrey/pipeline/deep_panel.py#L1255)), not at parse
...
[`_render_sources_block`](../../src/audrey/pipeline/deep_panel.py#L1294) returns
...
[`deep_panel.py:1741`](../../src/audrey/pipeline/deep_panel.py#L1741). The hedging
...
([`deep_panel.py:1789`](../../src/audrey/pipeline/deep_panel.py#L1789)). The
...
([`_render_sources_block`](../../src/audrey/pipeline/deep_panel.py#L1294),
