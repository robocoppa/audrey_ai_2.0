...
**Status:** In progress as of 2026-08-26. Waves 1A and 1B are Unraid-verified;
Wave 1C.1 is laptop-complete and awaiting its deployment smoke.
...
|---|---|---|---|---|
| 01 | [Platform hardening](phase-01-platform-hardening-plan.md) | Strengthen data boundaries, request ownership, storage lifecycle, readiness, and runtime reproducibility | Campaign start | In progress (1C.1 deploy smoke next) |
